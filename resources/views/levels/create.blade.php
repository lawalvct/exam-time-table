    ...
    <x-slot name="header">
        ...
        @if(config('app.debug'))
            <div class="mt-2 text-xs text-gray-500 font-mono">
                View: resources/views/levels/create.blade.php | Controller: LevelController@create | Route: levels.create
            </div>
        @endif
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('levels.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#008751] focus:ring focus:ring-[#008751] focus:ring-opacity-50" placeholder="e.g. ND 1">
