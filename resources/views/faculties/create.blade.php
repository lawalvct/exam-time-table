<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Add New Faculty / School') }}
        </h2>
        @if(config('app.debug'))
            <div class="mt-2 text-xs text-gray-500 font-mono">
                View: resources/views/faculties/create.blade.php | Controller: FacultyController@create | Route: faculties.create
            </div>
        @endif
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('faculties.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="code" id="code" value="{{ old('code') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#008751] focus:ring focus:ring-[#008751] focus:ring-opacity-50" placeholder="e.g. SOS">
